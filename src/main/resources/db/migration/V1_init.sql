...
\restrict cfJKuQD3Bn5cyEyEtFGWNZVf39YNrCA5zmA0VzsMhzIhYAvje8ts6Qt6i2pGRQw

-- Dumped from database version 14.2 (Debian 14.2-1.pgdg110+1)
-- Dumped by pg_dump version 18.3

-- Started on 2026-04-24 06:52:52
...
ALTER TABLE public.contract_document OWNER TO "user";
...
ALTER TABLE public.eligibility OWNER TO "user";

--
-- TOC entry 210 (class 1259 OID 16393)
-- Name: eligibility_eligibility_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

ALTER TABLE public.eligibility ALTER COLUMN eligibility_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.eligibility_eligibility_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.fulfilment_type OWNER TO "user";

--
-- TOC entry 212 (class 1259 OID 16399)
-- Name: fulfilment_type_fulfilment_type_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

ALTER TABLE public.fulfilment_type ALTER COLUMN fulfilment_type_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.fulfilment_type_fulfilment_type_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: order_item_order_item_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
-- Name: order_order_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
ALTER TABLE public.qualifying_accounts OWNER TO "user";

--
-- TOC entry 222 (class 1259 OID 16438)
-- Name: qualifying_accounts_qualifying_accounts_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

ALTER TABLE public.qualifying_accounts ALTER COLUMN qualifying_accounts_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.qualifying_accounts_qualifying_accounts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.qualifying_customer_types OWNER TO "user";

--
-- TOC entry 224 (class 1259 OID 16444)
-- Name: qualifying_customer_types_qualifying_customer_types_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

ALTER TABLE public.qualifying_customer_types ALTER COLUMN qualifying_customer_types_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.qualifying_customer_types_qualifying_customer_types_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
